...
{
    public class PrintDostavaCommand : ICommand
    {
        public event EventHandler CanExecuteChanged;

        private KuhinjaViewModel _currentViewModel;

        public PrintDostavaCommand(KuhinjaViewModel currentViewModel)
        {
        ...
        public void Execute(object parameter)
        {
            try
            {
                ...
                using (var dbContext = _currentViewModel.DbContext.CreateDbContext())
                {
                    var allOrdersToday = dbContext.OrdersToday.Include(o => o.OrderTodayItems)
                        ...
                        (o.PaymentPlace.Name.ToLower().Contains("dostava") || o.PaymentPlace.Name.ToLower().Contains("dostave")) &&
            ...
            {
                Log.Error("PrintDostavaCommand -> desila se greska prilikom stampe arikala za dostavu: ", ex);
